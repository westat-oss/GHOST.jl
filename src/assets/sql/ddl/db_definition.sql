...
--
-- Name: test_usr_codegov; Type: TABLE; Schema: ghost; Owner: postgres
--

CREATE TABLE ghost.test_usr_codegov (
    id text NOT NULL,
    login text,
    acctype text
);

ALTER TABLE ghost.test_usr_codegov ADD COLUMN createdat timestamp without time zone, ADD COLUMN location text;
ALTER TABLE ghost.test_usr_codegov ADD COLUMN bio text, ADD COLUMN company text, ADD COLUMN pronouns text, ADD COLUMN isDeveloperProgramMember bool, ADD COLUMN isEmployee bool, ADD COLUMN updatedAt timestamp without time zone, ADD COLUMN twitterUsername text, ADD COLUMN websiteUrl text, ADD COLUMN socialAccounts text[], ADD COLUMN organization_ids text[], ADD COLUMN organization_logins text[], ADD COLUMN user_email text;

ALTER TABLE ghost.test_usr_codegov OWNER TO postgres;
